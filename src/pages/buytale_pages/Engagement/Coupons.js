...
class BasketCoupons extends Component {
    constructor(props) {
        super(props);
        this.state = {
            breadcrumbItems : [
    ...
    componentDidMount(){
        this.props.setBreadcrumbItems("Coupons", this.state.breadcrumbItems);
    }
            ...
            <React.Fragment>
                        <div className="card card-body text-center">
                            <CardBody>
                                ...
                                <CardText>Create coupon codes to offer discounts to your customers and increase revenue.
                                </CardText>
...
export default connect(null, { setBreadcrumbItems })(BasketCoupons)