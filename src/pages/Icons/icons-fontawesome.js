...
class IconFontawesome extends Component {
    ...
    componentDidMount(){
        this.props.setBreadcrumbItems("Font Awesome", this.state.breadcrumbItems);
    }
                        ...
                        <Col xs="12">
                            <Card>
                                <CardBody>
                                    ...
                                    <p className="card-title-desc">Use <code>&lt;i className="fab fa-500px"&gt;&lt;/i&gt;</code> <span className="badge badge-success">v 5.8.1</span>.</p>
...
export default connect(null, { setBreadcrumbItems })(IconFontawesome);